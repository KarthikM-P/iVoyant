...
import { useAddTaskMutation, useDeleteTaskMutation, useGetTasksQuery, useUpdateTaskMutation } from "./MainStore";
...
export default function Home() {
  ...
  const {data:tasksList, isError, error, isLoading} = useGetTasksQuery();
